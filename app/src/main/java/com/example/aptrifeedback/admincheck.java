...
public class admincheck extends Activity {
    ...
    private static final String TAG = "admincheck";
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(admincheck.this, "Sign In Successful", Toast.LENGTH_SHORT).show();

                            startActivity(new Intent(admincheck.this,inadmin.class));
                            finish();
                            ...
                            Toast.makeText(admincheck.this, "Authentication failed.",
