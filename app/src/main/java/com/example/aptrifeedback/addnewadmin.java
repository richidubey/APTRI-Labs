...
public class addnewadmin extends Activity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(addnewadmin.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            //  Toast.makeText(HomeActivity.this, "Registeration Failed :( !!", Toast.LENGTH_SHORT).show();

                            Log.w(TAG, "createUserWithEmail:failure", task.getException());
                            Toast.makeText(addnewadmin.this, "Registration failed. No Internet Maybe? Or you didnt write proper email? Or your password is too small.",
