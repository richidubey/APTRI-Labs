...
public class deletetraining extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.deletetraining);
    ...
    public void submit(View view)
    {
        ...
        databaseReferencetraining.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot trainingSnapshot: dataSnapshot.getChildren())
                {
                    ...
                    if(training.getTitle().equals(tit.getSelectedItem().toString()))
                    {

                        DatabaseReference databaseReferencedel;

                        databaseReferencedel= FirebaseDatabase.getInstance().getReference("training");

                        databaseReferencedel.child(trainingSnapshot.getKey()).removeValue();
        ...
        Toast.makeText(this,"Deleted " + tit.getSelectedItem().toString()+" Training successfully!",Toast.LENGTH_LONG).show();
        finish();
    }
}
